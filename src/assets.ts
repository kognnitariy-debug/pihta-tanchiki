...
// Всплывающая карточка использует детализированные песочные руны.
// Маленькие руны в дашбордах остаются лёгкими processed-версиями.
export const RESULT_RUNE_IMAGES: Record<Figure, string> = {
  Пихта: '/assets/runes/result/pichta.png',
  Танчик: '/assets/runes/result/tanchik.png',
  Самолёт: '/assets/runes/result/samolet.png',
  Подвода: '/assets/runes/result/podvoda.png',
  Вертолёт: '/assets/runes/result/vertolet.png',
  Корпус: '/assets/runes/result/corpus.png',
  Армия: '/assets/runes/result/army.png',
  Бомба: '/assets/runes/result/b.png',
};
